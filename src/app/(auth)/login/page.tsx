...
//   // If already logged in, this will be handled by middleware
//   // But we can add a redirect here too
//   // useEffect(() => {
//   //   if (isAuthenticated) {
//   //     router.push('/course');
//   //   }
...
//         <form className="mt-8 space-y-6" onSubmit={handleSubmit(onSubmit)}>
//           {/* Display login error from TanStack Query */}
//           {loginError && (
//             <div className="bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded">
...
//           <Button type="submit" loading={isLoggingIn} disabled={isLoggingIn}>
